...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_string(self):
        '''t_roman should fail with string input'''
        self.assertRaises(roman1.NotIntegerError,roman1.to_roman, 't')
...
class FromRomanBadInput(unittest.TestCase):
    ...
    def test_non_string(self):
        ...
        self.assertRaises(roman1.InvalidRomanNumeralError, roman1.from_roman, 1)

    def test_lowercase(self):
        '''from_roman should fail with lowercase input'''
        self.assertRaises(roman1.LowercaseInputError, roman1.from_roman, 'x')
